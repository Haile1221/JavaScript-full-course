...
li6.insertAdjacentHTML("beforebegin", "<li>Beforebegin: This goes *before begin* li6</li>")
li6.insertAdjacentHTML("afterbegin", "<li>Afterbegin: This goes *After begin* li6</li>")
li6.insertAdjacentHTML("beforeend", "<li>Beforeend: This goes *before end* li6</li>")
li6.insertAdjacentHTML("afterend", "<li>Afterend: This goes *afterend* li6</li>")